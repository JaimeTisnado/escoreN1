...
$myPicture->drawGradientArea(0,0,500,100,DIRECTION_HORIZONTAL,array("StartR"=>238,"StartG"=>238,"StartB"=>238,"EndR"=>238,"EndG"=>238,"EndB"=>238,"Alpha"=>20));

/* Add a border to the picture */
$myPicture->drawRectangle(0,0,499,199,array("R"=>238,"G"=>238,"B"=>238));

/* Set the default font */ 
$myPicture->setFontProperties(array("FontName"=>pathChart."/fonts/verdana.ttf","FontSize"=>8,"R"=>80,"G"=>80,"B"=>80));

/* Define the chart area */ 
$myPicture->setGraphArea(100,70,450,150);
