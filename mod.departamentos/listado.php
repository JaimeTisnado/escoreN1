...
inner join paises b
	...
	and b.idPais = $ID
where lower(a.nomDepartamento) like lower('%$txtNombre%')
...
/* Descripcion de ROW */
$sArrayPais	= fndb_getPaisbyId($ID);
$sDescr = $sArrayPais[strtolower('nomPais')];
...
<div class="column100">
    ...
    <div class="widget">
    	<div class="widget_header">
            <i class="icon-widget fa-list"></i><h3>Listado de Departamentos [<?php echo $sDescr; ?>]</h3>
        </div>
        <div class="widget_content">
        	...
        	<div id="PanelDetalle">
             <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td class="TDTitle">Busqueda<a id="btnNuevo" href="mant_Departamento.php?idPais=<?php echo $ID; ?>" class="btn right"><i class="icon-fa fa-file-o"></i>Agregar Departamento</a>
                  <a href="<?php echo JPATH_BASE_WEB.DSW; ?>mod.paises/listado.php" class="btn right" title="Regresar<p>Listado de Paises</p>"><i class="icon-fa fa-rotate-left"></i>Regresar</a>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table cellpadding="0" cellspacing="1" class="adminList">
                    ...
                    <?php
						...
						{
							$idDepartamento		= $sRow[strtolower('idDepartamento')];
							$nomDepartamento	= $sRow[strtolower('nomDepartamento')];
							$codigoDepartamento	= $sRow[strtolower('codigoDepartamento')];
							...
							$imgDeptos = "<a href='".JPATH_BASE_WEB.DSW."mod.municipios/listado.php?id=$idDepartamento' title='Detalle de Municipios'>";
							$imgDeptos .= "<img src='".JPATH_BASE_WEB.DSW."imagenes/_ui_menu_16.png' /></a>";
							
							$hrefEdit 	= "mant_Departamento.php?idPais=".$ID."&id=".$idDepartamento;
							
						?>
                    <tr>
                      <td><a href="<?php echo $hrefEdit; ?>" title="Editar Departamento"><?php echo $nomDepartamento ?></a></td>
                      <td><?php echo $codigoDepartamento ?></td>
                      <td class="alinearCentro"><?php echo $imgActivo ?></td>
                      <td class="alinearCentro"><?php echo $imgDeptos ?></td>
                    </tr>
                    <?php
						}
						?>
