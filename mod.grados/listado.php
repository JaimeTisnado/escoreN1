...
$sSql = ("
select a.idGrado, a.nomGrado, a.codigoGrado, a.memoGrado, a.isActivo
from grados a
where lower(a.nomGrado) like lower('%$txtNombre%')
...
<div class="column100">
    ...
    <div class="widget">
    	<div class="widget_header">
            <i class="icon-widget fa-list"></i><h3>Listado de Grados</h3>
        </div>
        <div class="widget_content">
        	...
        	<div id="PanelDetalle">
             <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td class="TDTitle">Busqueda<a id="btnNuevo" href="mant_Grado.php" class="btn right"><i class="icon-fa fa-file-o"></i>Agregar Grado</a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table cellpadding="0" cellspacing="1" class="adminList">
                    ...
                    <?php
						...
						{
							$idGrado		= $sRow[strtolower('idGrado')];
							$nomGrado		= $sRow[strtolower('nomGrado')];
							$codigoGrado	= $sRow[strtolower('codigoGrado')];
							...
							$hrefEdit 	= "mant_Grado.php?id=".$idGrado;
							
						?>
                    <tr>
                      <td><a href="<?php echo $hrefEdit; ?>" title="Editar Grado"><?php echo $nomGrado ?></a></td>
                      <td><?php echo $codigoGrado ?></td>
                      <td class="alinearCentro"><?php echo $imgActivo ?></td>
                      <td class="alinearCentro"></td>
                    </tr>
                    <?php
						}
						?>
