...
if ( strlen(trim($txtValor)) == 0 ){
	$s_eValor	= 1;
	$eValor 	= "Requerido";
}

	if($s_eNombre != 1 && $s_eValor != 1 ){
	
		if(isset($ID)){
		
			fndb_editarConfiguracion($idUsuario, $ID, $txtNombre, $txtValor);
			$cssMensaje	= fn_getCssMensaje(1);
			$lblMensaje	= "Configuración Modificada Correctamente";
			echo '<script type="text/javascript">
				window.history.go(-2);
				</script>';
		}
		else {
			#fndb_nuevoPais($idUsuario, $txtNombre, $rbPub);
...
$txtNombre 			= ( (isset($txtNombre)) ? $txtNombre : $sArray[strtolower('nomConfiguracion')] ); 
$txtValor 			= ( (isset($txtValor)) ? $txtValor : $sArray[strtolower('valorConfiguracion')] );
...
<div class="column100">
    ...
    <div class="widget">
    	<div class="widget_header">
            <i class="icon-widget fa-list"></i><h3><?php echo $mantNombre ?> Configuración</h3>
        </div>
            ...
            <div id="PanelMantenimiento">
            	<form id="form1" name="form1" method="post" action="">
                        <table cellpadding="0" cellspacing="1">
                          ...
                          <tr>
                            <td class="row_form">Valor:</td>
                            <td><input name="txtValor" type="text" class="Requerido" id="txtValor" value="<?php echo $txtValor; ?>" size="15" maxlength="80" />
                            <?php echo '<span class="letraError">'.$eValor.'</span>'; ?></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
