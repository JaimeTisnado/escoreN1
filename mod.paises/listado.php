...
from paises a
where lower(a.nomPais) like lower('%$txtNombre%')
...
<div class="column100">
    ...
    <div class="widget">
    	<div class="widget_header">
            <i class="icon-widget fa-list"></i><h3>Listado de Paises</h3>
        </div>
        <div class="widget_content">
        	...
        	<div id="PanelDetalle">
             <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="TDTitle">Busqueda<a id="btnNuevo" href="mant_Pais.php" class="btn right"><i class="icon-fa fa-file-o"></i>Agregar Pais</a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td><table cellpadding="0" cellspacing="1" class="adminList">
                    ...
                    <?php
						...
						{
							$idPais		= $sRow[strtolower('idPais')];
							$nomPais	= $sRow[strtolower('nomPais')];
							$codigoPais	= $sRow[strtolower('codigoPais')];
						...
						$imgDeptos = "<a href='".JPATH_BASE_WEB.DSW."mod.departamentos/listado.php?id=$idPais' title='Detalle de Departamentos'>";
							$imgDeptos .= "<img src='".JPATH_BASE_WEB.DSW."imagenes/_ui_menu_16.png' /></a>";
							
							$hrefEdit 	= "mant_Pais.php?id=".$idPais;
							
						?>
                    <tr>
                      <td><a href="<?php echo $hrefEdit; ?>" title="Editar Perfil"><?php echo $nomPais ?></a></td>
                      <td><?php echo $codigoPais ?></td>
